                ...
                <div className="overflow-x-auto">
                  <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gray-50">
                      <tr>
                        {['SN', 'Campaign ID', 'Name', 'Type', 'Content', 'Sent', 'Status', 'Size', 'Channels', 'Date', 'Time', 'Delivered', 'Actions'].map(header => (
                            ...
                            <tr key={row.campaign_id + index} className="hover:bg-gray-50 transition duration-150">
                              ...
                              <td className="px-6 py-4 whitespace-nowrap text-sm">
                                <button
                                  ...
                                  className="px-3 py-1 text-xs font-semibold text-white bg-gradient-to-r from-pink-500 to-rose-500 rounded-full hover:shadow-md transition transform hover:-translate-y-0.5"
                                >
                                  {row.content_type || 'Zip'}
                                </button>
                              </td>
                              ...
                              <td className="px-6 py-4 whitespace-nowrap text-sm">
                                <div className="flex space-x-2">
                                    ...
                                    className="p-2 text-white bg-indigo-500 rounded-lg hover:bg-indigo-600 transition shadow-sm"
