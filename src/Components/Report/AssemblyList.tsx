...
//         ];
//         title = `All Assemblies Overview (${assemblyData.length} Assemblies)`;
//     } else {
...
//           </svg>
//           All Assemblies Data Overview ({filteredAssemblies.length} Assemblies)
//         </h4>
...
//                     </div>
//                     {/* Individual Assembly Summary Values */}
...
//                               <canvas ref={individualChartRef}></canvas>
//                             </div>
//                             {/* Desktop Individual Assembly Summary Values */}
//                             <div className="grid grid-cols-3 gap-2 mt-3 text-center text-xs">
//                               <div className="bg-green-50 p-2 rounded">
//                                 <div className="text-green-700 font-medium">Verified</div>
//                                 <div className="text-green-800 font-bold">{assembly.boothSummary.verifiedBooths}</div>
